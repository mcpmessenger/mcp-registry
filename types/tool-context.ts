 ...
 */
export function findToolsByOutputContext(outputContext: string): ToolContext[] {
  return Object.values(TOOL_CONTEXTS).filter(
    context => context.outputContext.toLowerCase().includes(outputContext.toLowerCase())
  )
}
 ...
 */
export function findToolsByResponsibility(responsibility: string): ToolContext[] {
  return Object.values(TOOL_CONTEXTS).filter(
    context => context.coreResponsibility.toLowerCase().includes(responsibility.toLowerCase())
  )
}
